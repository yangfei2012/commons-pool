 ...
 *     {@link GenericObjectPool#getMinEvictableIdleTimeMillis()} / {@link GenericKeyedObjectPool#getMinEvictableIdleTimeMillis()}</li>
 * <li>there are more than
 *     {@link GenericObjectPool#getMinIdle()} / {@link GenericKeyedObjectPoolConfig#getMinIdlePerKey()}
 *     idle objects in the pool
 *     and
 *     the object has been idle for longer than
 *     {@link GenericObjectPool#getSoftMinEvictableIdleTimeMillis()} / {@link GenericKeyedObjectPool#getSoftMinEvictableIdleTimeMillis()}
 * </ul>
